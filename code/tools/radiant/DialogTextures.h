...
protected:
// jmarshall
	bool CountTexturesInTree(HTREEITEM item, idStr name, int &numTextures);
// jmarshall end
...
// jmarshall
	bool loadTree( HTREEITEM item, const idStr &name, RadiantProgressDialog *dlg, int &maxTextures, int &currentTexturesLoaded );
// jmarshall end
