...
public:
	...
	virtual int				GetNumMSAASamples(void) const;
	...
	virtual void			DrawStretchPic ( const idDrawVert *verts, const glIndex_t *indexes, int vertCount, int indexCount, const idMaterial *material,
											bool clip = true, float x = 0.0f, float y = 0.0f, float w = SCREEN_WIDTH, float h = SCREEN_HEIGHT );
...
extern idCVar r_msaa_samples;			// number of antialiasing samples
...
================
*/
ID_INLINE void Draw_SetVertexParm(renderParm_t rp, const float * value) {
...
================
*/
ID_INLINE void Draw_SetVertexParms(renderParm_t rp, const float * value, int num) {
	for (int i = 0; i < num; i++) {
...
/*
================
Draw_SetFragmentParm
================
*/
ID_INLINE void Draw_SetFragmentParm(renderParm_t rp, const float * value) {
	renderProgManager.SetUniformValue(rp, value);
}
...
================
*/
ID_INLINE void Draw_SetMVP(const idRenderMatrix & mvp) {
