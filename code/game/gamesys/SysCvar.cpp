...
idCVar pm_jumpheight(				"pm_jumpheight",			"65",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "approximate hieght the player can jump" );
...
idCVar g_gun_x(						"g_gunX",					"2",			CVAR_GAME | CVAR_FLOAT, "" );
idCVar g_gun_y(						"g_gunY",					"-10",			CVAR_GAME | CVAR_FLOAT, "" );
idCVar g_gun_z(						"g_gunZ",					"-10",			CVAR_GAME | CVAR_FLOAT, "" );
