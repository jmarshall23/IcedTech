...
==================
*/
void idSysLocal::StartProcess( const char *exeName, bool quit, const char *inDirectory ) {
    if( inDirectory ){
        common->DPrintf("StartProcess inDirectory not supported on linux, lol\n");
    }
    if ( quit ) {
...
void Sys_SetClipboardData( const char *string ) {
    Sys_Printf( "TODO: Sys_SetClipboardData(%s)\n", string );
}
...
int	Sys_GetVideoRam( void ) {
    common->DPrintf( "TODO: Sys_GetVideoRam.. Assuming you have 2GB!\n" );
    return 2000 * 2048;
}
...
{
    common->DPrintf("Sys_DefaultCDPath called! Not implemented!\n");
    return "";
}
